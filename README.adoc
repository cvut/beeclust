...
- tráva, zdi a šipky jsou stejné jako https://github.com/cvut/naucse.python.cz/tree/b181/lessons/intro/pyqt/static/pics[ze cvičení] od studia https://kenney.nl[Kenney] stáhnutelné 
